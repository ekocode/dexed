...
Colour DXLookNFeel::libraryDarkBackground = DXLookNFeel::background.interpolatedWith(Colour(0,0,0), 0.5f);
Colour DXLookNFeel::libraryDarkBackgroundAlt = DXLookNFeel::background.interpolatedWith(Colour(0,0,0), 0.6f);
Colour DXLookNFeel::libraryText = DXLookNFeel::fillColour;
Colour DXLookNFeel::libraryDarkText = Colour(0,0,0);
Colour DXLookNFeel::librarySelectedBackground = DXLookNFeel::fillColour.interpolatedWith(Colour(0,0,0), 0.6f);
